<template>	
  <form id="signup_form" class="container sp-form" action="#" method="post" accept-charset="utf-8">
  	<div class="sp-form-innerbox">
	    ...
	    <div class="container sp-form-input-box">
	      ...
	      for="advisor" 
	      :style="advisorLbStyle">Your Full Name <i class="star">*</i>
	    </label>
	    </div>
	    <div class="container sp-form-input-box">
	      <input 
	      ...
	      class="sp-form-input-hint" 
	      for="email" 
	      :style="emailLbStyle">Your Email <i class="star">*</i>
	      </label>
	    </div>
	    <div class="container sp-form-input-box">
	      <input 
	      ...
	      class="sp-form-input-hint" 
	      for="phone" 
	      :style="phoneLbStyle">Your Phone <i class="star">*</i>
	      </label>
	    </div>
	    <div class="container sp-form-input-box">
	      <textarea 
	      ...
	      class="sp-form-input-hint" 
	      for="message" 
	      :style="messageLbStyle">Message <i class="star">*</i>
	      </label>
	    </div>
	    <div class="container sp-form-btn-box">
	      <button class="btn sp-form-btn red" @click.prevent="submit">SUBMIT NOW</button>
	    </div>
  	</div>
  </form>
</template>
